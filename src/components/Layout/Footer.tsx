        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold leading-tight">BrickSure</span>
                <span className="text-xs text-blue-300 self-end leading-none italic">by STI</span>
              </div>
            </div>
            <p className="text-gray-400 text-sm mb-4">
              Insure your space, secure your peace. Nigeria's leading digital property insurance platform.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/coverage" className="text-gray-400 hover:text-white text-sm transition-colors">Coverage & Pricing</Link></li>
              <li><Link to="/community-risk-insights" className="text-gray-400 hover:text-white text-sm transition-colors">Community & Risk Insights</Link></li>
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                ...
                <span className="text-gray-400 text-sm">hello@bricksure.ng</span>
              </div>
              <div className="flex items-center space-x-2">
                <Phone className="h-4 w-4 text-blue-400" />
                <span className="text-gray-400 text-sm">+234 800 BRICK (27425)</span>
              </div>
              <div className="flex items-center space-x-2">
        ...
        <div className="border-t border-gray-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} BrickSure. All rights reserved.
            </p>
            <p className="text-gray-400 text-sm mt-2 md:mt-0">
              Licensed by NAICOM • Regulated by CBN
            </p>
          </div>
        </div>
      </div>
