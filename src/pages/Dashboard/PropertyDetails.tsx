...
export function PropertyDetails() {
  ...
  const coverageOptions = [
    { id: 'liability', name: 'Public Liability', price: 8000, description: 'Protection against third-party claims' },
    { id: 'contents', name: 'Contents Insurance', price: 12000, description: 'Coverage for personal belongings' },
    { id: 'lossOfRent', name: 'Loss of Rent', price: 6000, description: 'Compensation for rental income loss' }
  ];
  ...
  const handleCancelSubscription = async () => {
    ...
    try {
      ...
      addToast({
        ...
        message: 'Your policy will remain active until the current term expires'
      });
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <Card className="p-6 animate-fade-in">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white mb-4">Basic Details</h3>
                    <div className="space-y-3">
                      ...
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900 dark:text-white">{property.yearBuilt}</p>
                        </div>
                      </div>
                      <div className="flex items-start space-x-3">
                        ...
                        <div>
                          ...
                          <p className="font-medium text-gray-900 dark:text-white">{property.images} uploaded</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div>
                    <h3 className="font-medium text-gray-900 dark:text-white mb-4">Coverage Details</h3>
                    <div className="space-y-2">
                      {Object.entries(property.coverage).map(([key, covered]) => (
                        <div key={key} className="flex items-center space-x-2">
                          ...
                          <span className={`text-sm ${covered ? 'text-gray-900 dark:text-white' : 'text-gray-500 dark:text-gray-400'}`}>
            ...
            <div className="space-y-6">
              {/* Wallet Balance */}
              <Card className="p-6 animate-fade-in" style={{ animationDelay: '450ms' }}>
              ...
              <Card className="p-6 animate-fade-in" style={{ animationDelay: '600ms' }}>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="font-medium text-gray-900 dark:text-white">{property.tier}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Annual Premium</p>
                    <p className="font-medium text-gray-900 dark:text-white">₦{property.premium.toLocaleString()}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600 dark:text-gray-400">Next Payment</p>
                    <p className="font-medium text-gray-900 dark:text-white">
                      {new Date(property.nextPayment).toLocaleDateString('en-NG', {
                        year: 'numeric',
                        month: 'long',
                        day: 'numeric'
                      })}
              ...
              {/* Quick Actions */}
              <Card className="p-6 animate-fade-in" style={{ animationDelay: '750ms' }}>
              ...
              <div className="flex items-start space-x-3 p-4 bg-yellow-50 dark:bg-yellow-900/20 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-700 dark:text-yellow-400 mt-1">
                    Your policy will remain active until {new Date(property.nextPayment).toLocaleDateString('en-NG')}. 
