...
export function Policies() {
  ...
  const policies = [
    {
      ...
      certificateUrl: '#',
      policyDocUrl: '#',
      coverage: ['Fire', 'Flood', 'Burglary', 'Storm']
    },
    {
      id: 'POL-2024-002',
      ...
      certificateUrl: '#',
      policyDocUrl: '#',
      coverage: ['Fire', 'Flood', 'Burglary', 'Storm', 'Liability', 'Contents']
    },
    {
      id: 'POL-2023-015',
      propertyAddress: '8 Victoria Island, Lagos',
      policyNumber: 'BS-2023-000890',
      status: 'expired',
      tier: 'Basic',
      premium: 15000,
  ...
  const filteredPolicies = policies.filter(policy => {
    ...
    const matchesSearch = policy.propertyAddress.toLowerCase().includes(searchTerm.toLowerCase()) ||
  ...
  const downloadAllHistory = () => {
    ...
    element.href = 'data:text/plain;charset=utf-8,' + encodeURIComponent('Policy History Report\n\nGenerated on: ' + new Date().toLocaleDateString());
            ...
            <Card className="p-6 hover:shadow-xl transition-all duration-300 hover:scale-105 animate-fade-in" style={{ animationDelay: '300ms' }}>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <p className="text-lg font-bold text-gray-900 dark:text-white">Mar 15</p>
                </div>
              </div>
            </Card>
          </div>
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
              ...
              <div className="flex space-x-1 bg-gray-100 dark:bg-gray-800 rounded-lg p-1">
                {[
                  ...
                  { key: 'expired', label: 'Expired', count: policies.filter(p => p.status === 'expired').length },
          ...
          {filteredPolicies.length === 0 ? (
            <Card className="p-12 text-center animate-fade-in">
              ...
              <p className="text-gray-600 dark:text-gray-400 mb-6">
                {searchTerm ? 'Try adjusting your search terms' : 'You don\'t have any policies in this category yet'}
              </p>
              {!searchTerm && (
                <Button asChild>
                ...
                >
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="flex-1">
                        <div className="flex items-center space-x-3 mb-2">
                          ...
                          <span className={`inline-flex items-center px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(policy.status)}`}>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {policy.tier} Tier • ₦{policy.premium.toLocaleString()}/year
                        </p>
                      </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                      <div>
                        <p className="text-xs text-gray-500 dark:text-gray-400 mb-1">Policy Period</p>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-1">
                          {policy.coverage.slice(0, 3).map((item, idx) => (
                            <span key={idx} className="px-2 py-1 text-xs bg-blue-100 text-blue-800 dark:bg-blue-900/50 dark:text-blue-400 rounded">
                              {item}
                            </span>
                          ))}
